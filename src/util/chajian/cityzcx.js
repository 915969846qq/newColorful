...
class Craftsman_Settled extends Component {
    ...
    componentDidMount() {
        ...
        if(this.props.changeaddress==undefined){
            this.setState({
                province: this.props.address.split('-')[0],
                cities: this.getCity(this.props.address.split('-')[0]),
                city: this.props.address.split('-')[1],
                counties: this.getCounty(this.props.address.split('-')[0], this.props.address.split('-')[1]),
                county: this.props.address.split('-')[2]
            });
        }
        else{
            this.setState({
                province: this.props.changeaddress.split('-')[0],
                cities: this.getCity(this.props.changeaddress.split('-')[0]),
                city: this.props.changeaddress.split('-')[1],
                counties: this.getCounty(this.props.changeaddress.split('-')[0], this.props.changeaddress.split('-')[1]),
                county: this.props.changeaddress.split('-')[2]
            });
        }
...
const MapStateToProps = (state, OwnProps) => {
    return {
        ...
        address:state.cartorder.getaddress.data[0].address,
        changeaddress:state.cartorder.changeaddress,
    }
}
...
export default connect(MapStateToProps, MapDispatchToProps)(Craftsman_Settled)
