  ...
  gobuy(index,t){
    this.setState({
      choosearr:[{
        ...
        price:parseInt(this.state.goodsInfo[index].price.slice(1,this.state.goodsInfo[index].price.length)),
      ...
      console.log(parseInt(this.state.goodsInfo[index].price.slice(1,this.state.goodsInfo[index].price.length)));
      console.log(this)
