...
componentDidMount(){
    let phone=parseInt(JSON.parse(sessionStorage.getItem("user")).user)
    this.setState({
        phone:phone
    })
}
        ...
        return (
            <div className="chenming2">
                <div className="security_center">
                    ...
                    <div >
                        <span>手机号 :</span>
                        <Input placeholder="请输入您的手机号码" type="number" disabled value={this.state.phone} onChange={this.onchange.bind(this,"phone")} onBlur={this.phonereal} style={{width:250}} /> 
