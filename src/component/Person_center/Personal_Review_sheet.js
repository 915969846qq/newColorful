            ...
            .then((response) => {
              ...
              that.setState(
                ...
                () => {
                  // 总共的页数
                  let getnumber = Math.ceil(
                    that.state.data.length / that.state.Lnumber
                  )
                  // 总数据条数
                  let getlength = that.state.data.length
                  that.setState(
                    { pageNumber: getnumber, totle: getlength },
                    () => {
                      console.log(that.state)
                    }
                  )
        ...
        if (ruie === null) {
          ...
          axios
            ...
            .then((response) => {
              ...
              for (let i = xiao; i < da; i++) {
                if (newmydata[i] === undefined) {
                  break
                } else {
                  isdata.push(newmydata[i])
                }
              }
              console.log(isdata)
              that.setState(
        ...
        >
          <div className="fang_WBColor fang_Width1200">
            <p className="fang_paddingt20">
              ...
              <span className="fang_padding45">
                下单时间 : {this.state.ModelDate.createdDate}
              </span>
            </p>
            <Row>
              <Col span={6} className="fang_lineR fang_paddingall">
                ...
                <p className="fang_paddingt20">
                  {this.state.ModelDate.goodsDetail}
                </p>
                <p className="fang_paddingt10">
                  商品价格 : {this.state.ModelDate.price}
                </p>
                <p className="fang_paddingt10">
                  商品出售信息 : {this.state.ModelDate.shopname}——
                  {this.state.ModelDate.price}
                </p>
              </Col>
