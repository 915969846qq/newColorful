    ...
    render() { 
        ...
        <div >
            ...
            <div className="upload_success">
                ...
                <div>
                    <Button type="primary" danger><a href="/Personal_Center_index/Personal_second_hand_management">查看信息</a></Button>
                    <Button  type="primary" danger onClick={this.guanli}><a href="/Personal_Center_index/Personal_second_hand_management">管理信息</a></Button>
